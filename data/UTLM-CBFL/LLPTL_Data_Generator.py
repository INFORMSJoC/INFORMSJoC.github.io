'''************************************************************************
This is the data generation file for the paper

  " Lin, Y., Wang, Y., Lee, L. H., & Chew, E. P. (2022). 
    Profit-maximizing parcel locker location problem under threshold Luce model. 
    Transportation Research Part E: Logistics and Transportation Review, 157, 102541.""
