...
* [A Bi-level Network Interdiction Problem to Minimize the Number of Active Special Arcs in the Maximum Flow](https://doi.org/10.1287/ijoc.2023.0423) by Daniel B Lopes da Silva, Thomas Sharkey, Yongjia Song has associated [software/data](https://github.com/INFORMSJoC/2023.0423).
* [A Penalized Sequential Convex Programming Approach for Continuous Network Design Problem](https://doi.org/10.1287/ijoc.2024.0737) by Lei Guo, haian Yin, Jin Zhang has associated [software/data](https://github.com/INFORMSJoC/2024.0737).
* [MIP-DD: Delta Debugging for Mixed Integer Programming Solvers](https://doi.org/10.1287/ijoc.2024.0844) by Alexander Hoen, Dominik Kamp, Ambros Gleixner has associated [software/data](https://github.com/INFORMSJoC/2024.0844).
* [A Proximal DC Algorithm for Sample Average Approximation of Chance Constrained Programming](https://doi.org/10.1287/ijoc.2024.0648) by Peng Wang, Rujun Jiang, Qingyuan Kong, Laura Balzano has associated [software/data](https://github.com/INFORMSJoC/2024.0648).
* [Optimal System Adjustment Under Operational Constraints with Applications to Infectious Disease Screening](https://doi.org/10.1287/ijoc.2023.0048) by Marwan Shams Eddin, Hadi El-Amine, Hrayer Aprahamian has associated [software/data](https://github.com/INFORMSJoC/2023.0048).
* [Refined Wasserstein Distributionally Robust Optimization for Contract Pricing: The Value of Optimality Conditions in Transactions](https://doi.org/10.1287/ijoc.2024.0547) by Guodong Yu, Pengcheng Dong, Huiping Sun has associated [software/data](https://github.com/INFORMSJoC/2024.0547).
* [Inference in Higher Order Undirected Graphical Models and Binary Polynomial Optimization](https://doi.org/10.1287/ijoc.2024.0776) by Aida Khajavirad, Yakun Wang has associated [software/data](https://github.com/INFORMSJoC/2024.0776).
...
* [Cross-Entropy Method for the Maximal Covering Location Problem](https://doi.org/10.1287/ijoc.2024.0611) by Hongtao Wang and Jian Zhou has associated [software/data](https://github.com/INFORMSJoC/2024.0611).
* [Approximate Resolution of Stochastic Choice-based Discrete Planning](https://doi.org/10.1287/ijoc.2024.0694) by Jiajie Zhang, Yun Hui Lin, and Gerardo Berbeglia has associated [software/data](https://github.com/INFORMSJoC/2024.0694).
...
* [Efficient Project Scheduling with Automous Learning Opportunities](https://doi.org/10.1287/ijoc.2023.0107) by Alessandro Hill and Thomas Vossen has associated [software/data](https://github.com/INFORMSJoC/2023.0107).
* [An Efficient Scenario Reduction Method for Problems with Higher Moment Coherent Risk Measures](https://doi.org/10.1287/ijoc.2022.0375) by Xiaolei He and Weiguo Zhang has associated [software/data](https://github.com/INFORMSJoC/2022.0375).
* [Efficient Nested Simulation Experiment Design via the Likelihood Ratio Method](https://doi.org/10.1287/ijoc.2022.0392) by Mingbin Feng and Eunhye Song has associated [software/data](https://github.com/INFORMSJoC/2022.0392).
...
* [Satisficing Approach to On-Demand Ride Matching](https://doi.org/10.1287/ijoc.2021.0210) by Dongling Rong, Xinyu Sun, Meilin Zhang, and Shuangchi He has associated [software/data](https://github.com/INFORMSJoC/2021.0210).
* [Robust Parallel Pursuit for Large-Scale Association Network Learning](https://doi.org/10.1287/ijoc.2022.0181) by Wenhui Li, Xin Zhou, Ruipeng Dong, and Zemin Zheng has associated [software/data](https://github.com/INFORMSJoC/2022.0181).
...
* [A Fusion Pretrained Approach for Identifying the Cause of Sarcasm Remarks](https://doi.org/10.1287/ijoc.2022.0285) by Qiudan Li, David Jingjun Xu, Haoda Qian, Linzi Wang, Minjie Yuan, and Daniel Dajun Zeng has associated [software/data](https://github.com/INFORMSJoC/2022.0285).
...
* [The continuous time-resource tradeoff scheduling problem with time windows](https://doi.org/10.1287/ijoc.2022.0142) by Christian Artigues, Emmanuel Hebrard, Alain Quilliot, and Helene Toussaint has associated [software/data](https://github.com/INFORMSJoC/2022.0142).
* [A flow-based formulation for parallel machine scheduling using decision diagrams](https://doi.org/10.1287/ijoc.2022.0301) by Daniel Kowalczyk, Roel Leus, Christopher Hojny, and Stefan Ropke has associated [software/data](https://github.com/INFORMSJoC/2022.0301).
* [A Graph-based Approach for Relating Integer Programs](https://doi.org/10.1287/ijoc.2023.0255) by Zachary Steever, Kyle Hunt, Mark Karwan, Junsong Yuan, and Chase Murray has associated [software/data](https://github.com/INFORMSJoC/2023.0255).
* [Feasibility verification and upper bound computation in global minimization using approximate active index sets](https://doi.org/10.1287/ijoc.2023.0162) by Christian Füllner, Peter Kirst, Hendrik Otto, and Steffen Rebennack has associated [software/data](https://github.com/INFORMSJoC/2023.0162).
