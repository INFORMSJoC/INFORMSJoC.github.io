...
**Articles in Advance (AIA)**
  * (SCHEDULED FOR 34/3) [An Interior-Point Differentiable Path-Following Method to Compute Stationary Equilibria in Stochastic Games](https://doi.org/10.1287/ijoc.2021.1139) by Chuangyin Dang, P. Jean-Jacques Herings, and Peixuan Li, has associated [software/data](https://github.com/INFORMSJoC/2020.0259).
...
* [Revisiting semidefinite programming approaches to options pricing: complexity and computational perspectives](https://doi.org/10.1287/ijoc.2022.1220) by Didier Henrion, Felix Kirschner, Etienne de Klerk, Milan Korda, Jean-Bernard Lasserre, and Victor Magron, has associated [software/data](https://github.com/INFORMSJoC/2021.0321).
